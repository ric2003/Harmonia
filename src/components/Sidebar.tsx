...
export function Sidebar() {
    ...
    return (
        <div className="z-[2]">
            { sidebarOpen &&
                <div className="flex flex-col items-center h-full w-[300px] bg-white shadow-[rgba(0,0,0,0.25)_2px_0_20px_1px] z-[2]">
                    ...
                    <div className="w-full flex items-center justify-center absolute bottom-4">
                        <Switch.Root onCheckedChange={handleModeChange} className="cursor-pointer relative w-[160px] h-[38px] rounded-lg bg-lightGray outline-none data-[state=checked]:bg-darkGray">
                            <div className="flex">
                            ...
                            <Switch.Thumb className="top-1 absolute block w-[72px] h-[30px] translate-x-1 rounded-lg bg-white data-[state=checked]:translate-x-[84px] transition-transform" />
                        </Switch.Root>
                    </div>
                </div>
            }
